...
/// Although it is non-sealed, this class is not meant
...
/// </typeparam>
public partial class FamilyTree<TNode> : BaseScopeComponent where TNode : BaseNode
{
  /// <summary>
